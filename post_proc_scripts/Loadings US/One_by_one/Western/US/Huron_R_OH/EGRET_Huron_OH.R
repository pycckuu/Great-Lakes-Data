...
for(idx in c(1,2,3,4,5)) {
  ...
  river = "Huron_River_OH"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US/One_by_one/Western/US/Huron_R_OH/", sep="")
    sample_name = paste(species, "_", river, "_data.csv", sep = "")
    Daily <- readUserDaily(file_loc, "Flow_Huron_R_OH_CFS.csv", qUnit = 1)
