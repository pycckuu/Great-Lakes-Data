...
idx=1
  ...
  river = "Niagara_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada 2/One_by_one/Canada/Niagara_R/", sep="")
    sample_name = paste(species, "_", river, "_data.csv", sep = "")
    Daily <- readUserDaily(file_loc, "Flow_Niagara_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "TP_Niagara_River_data.csv")
