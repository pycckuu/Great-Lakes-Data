...
idx=1
  ...
  river = "Grand_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada 2/One_by_one/Canada/Grand_R/", sep="")
    sample_name = paste(species, "_", river, "_data.csv", sep = "")
    Daily <- readUserDaily(file_loc, "Flow_Grand_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "TP_Grand_River_data.csv")
