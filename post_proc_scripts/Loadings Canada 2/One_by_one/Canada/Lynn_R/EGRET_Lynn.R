...
idx=1
  ...
  river = "Lynn_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada 2/One_by_one/Canada/Lynn_R/", sep="")
    sample_name = paste(species, "_", river, "_data.csv", sep = "")
    Daily <- readUserDaily(file_loc, "Flow_Lynn_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "TP_Lynn_River_data.csv")
