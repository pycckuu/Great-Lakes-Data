...
idx=1
  ...
  river = "Ruscom_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada 2/One_by_one/Canada/Ruscom_R/", sep="")
    sample_name = paste(species, "_", river, "_data.csv", sep = "")
    Daily <- readUserDaily(file_loc, "Flow_Ruscom_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "TP_Ruscom_River_data.csv")
