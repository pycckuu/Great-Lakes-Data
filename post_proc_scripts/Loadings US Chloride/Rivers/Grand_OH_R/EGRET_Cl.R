...
idx=1
  ...
  river = "Grand_OH_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Grand_OH_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Grand_OH_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Grand_OH_River_data.csv")
