...
idx=1
  ...
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Black_R_MI/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Black_R_MI_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Black_R_MIiver_data.csv")
