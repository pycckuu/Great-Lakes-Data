...
idx=1
  ...
  river = "Detroit_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Detroit_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Detroit_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Detroit_River_data.csv")
