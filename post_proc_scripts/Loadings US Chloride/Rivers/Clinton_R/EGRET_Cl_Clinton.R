...
idx=1
  ...
  river = "Clinton_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Clinton_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Clinton_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Clinton_River_data.csv")
