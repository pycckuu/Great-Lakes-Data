...
idx=1
  ...
  river = "Maumee_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Maumee_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Maumee_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Maumee_River_data.csv")
