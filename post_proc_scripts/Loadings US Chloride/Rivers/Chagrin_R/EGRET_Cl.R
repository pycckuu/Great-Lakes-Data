...
idx=1
  ...
  river = "Chagrin_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Chagrin_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Chagrin_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Chagrin_River_data.csv")
