...
idx=1
  ...
  river = "Buffalo_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Buffalo_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Buffalo_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Buffalo_River_data.csv")
