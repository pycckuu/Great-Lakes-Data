...
idx=1
  ...
  river = "Portage_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Portage_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Portage_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Portage_River_data.csv")
