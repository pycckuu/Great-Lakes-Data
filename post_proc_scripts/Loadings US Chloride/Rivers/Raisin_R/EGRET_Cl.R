...
idx=1
  ...
  river = "Raisin_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Raisin_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Raisin_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Raisin_River_data.csv")
