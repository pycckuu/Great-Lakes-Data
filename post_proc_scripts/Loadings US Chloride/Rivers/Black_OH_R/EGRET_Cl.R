...
idx=1
  ...
  river = "Black_OH_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Black_OH_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Black_OH_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Black_OH_River_data.csv")
