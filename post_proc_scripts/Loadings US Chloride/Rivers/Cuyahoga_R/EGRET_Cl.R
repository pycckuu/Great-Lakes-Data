...
idx=1
  ...
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Cuyahoga_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Cuyahoga_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Cuyahoga_River_data.csv")
