...
idx=1
  ...
  river = "Huron_MI_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Huron_MI_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Huron_MI_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Huron_MI_River_data.csv")
