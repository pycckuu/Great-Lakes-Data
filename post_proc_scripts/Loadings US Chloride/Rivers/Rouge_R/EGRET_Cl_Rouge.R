...
idx=1
  ...
  river = "Rouge_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Rouge_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Rouge_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Rouge_River_data.csv")
