...
idx=1
  ...
  river = "Belle_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings US Chloride/Rivers/Belle_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Belle_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Belle_River_data.csv")
