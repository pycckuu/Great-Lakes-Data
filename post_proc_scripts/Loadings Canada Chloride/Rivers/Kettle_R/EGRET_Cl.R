...
idx=1
  ...
  river = "Kettle_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Kettle_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Kettle_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Kettle_River_data.csv")
