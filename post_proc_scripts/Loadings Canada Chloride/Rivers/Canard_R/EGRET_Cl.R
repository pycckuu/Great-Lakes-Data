...
idx=1
  ...
  river = "Canard_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Canard_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Canard_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Canard_River_data.csv")
