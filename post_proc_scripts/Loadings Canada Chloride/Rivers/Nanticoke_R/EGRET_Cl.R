...
idx=1
  ...
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Nanticoke_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Nanticoke_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Nanticoke_River_data.csv")
