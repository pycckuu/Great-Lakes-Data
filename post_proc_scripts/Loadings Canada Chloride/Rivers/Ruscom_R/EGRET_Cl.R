...
idx=1
  ...
  river = "Ruscom_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Ruscom_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Ruscom_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Ruscom_River_data.csv")
