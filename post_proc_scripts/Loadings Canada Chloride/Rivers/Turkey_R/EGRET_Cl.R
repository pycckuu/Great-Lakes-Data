...
idx=1
  ...
  river = "Turkey_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Turkey_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Turkey_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Turkey_River_data.csv")
