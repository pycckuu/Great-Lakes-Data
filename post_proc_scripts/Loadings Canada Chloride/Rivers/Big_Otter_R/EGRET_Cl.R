...
idx=1
  ...
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Big_Otter_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Big_Otter_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Big_Otter_River_data.csv")
