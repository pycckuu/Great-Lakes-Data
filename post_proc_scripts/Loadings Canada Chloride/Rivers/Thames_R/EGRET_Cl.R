...
idx=1
  ...
  river = "Thames_River"
  file_loc = paste("/Users/imarkelo/git/Great-Lakes-Data/post_proc_scripts/Loadings Canada Chloride/Rivers/Thames_R/", sep="")
    Daily <- readUserDaily(file_loc, "Flow_Thames_R_CFS.csv", qUnit = 1)
    Sample <- readUserSample(file_loc, "Cl_Thames_River_data.csv")
